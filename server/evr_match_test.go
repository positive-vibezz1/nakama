...
func TestSelectTeamForPlayer_With_Alighment(t *testing.T) {
	...
	for _, tt := range tests {
		...
		// New Player
		presence := &EvrMatchPresence{
			XPID:          lo.Must(evr.XPIDFromString(tt.newPlayer)),
...
func TestEvrMatch_MatchJoinAttempt(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		...
		presence := &EvrMatchPresence{
			...
			XPID:           evr.NewXPID(4, evr.AccountID(i)),
			DiscordID:      "10000" + s,
			ClientIP:       "127.0.0." + s,
			ClientPort:     "100" + s,
	...
	tests := []struct {
	...
	}{
		{
			...
			state: &MatchLabel{
				...
				reservationMap: map[string]*slotReservation{
					session1.String(): {Presence: &EvrMatchPresence{RoleAlignment: 0, SessionID: session1, XPID: evr.EvrId{PlatformCode: 1, AccountId: 1}}, Expiry: time.Now().Add(time.Minute)},
				},
				presenceMap: map[string]*EvrMatchPresence{
					session2.String(): {RoleAlignment: 1, SessionID: session2, XPID: evr.EvrId{PlatformCode: 1, AccountId: 2}},
				},
			},
			entrant:        &EvrMatchPresence{SessionID: session1, RoleAlignment: -1, XPID: evr.EvrId{PlatformCode: 1, AccountId: 1}},
			expectedResult: true,
			expectedError:  nil,
		},
		{
			...
			state: &MatchLabel{
				...
				PlayerLimit: 4,
				presenceMap: map[string]*EvrMatchPresence{
					session1.String(): {SessionID: session1, RoleAlignment: 0, XPID: evr.EvrId{PlatformCode: 1, AccountId: 1}},
					session2.String(): {SessionID: session2, RoleAlignment: 0, XPID: evr.EvrId{PlatformCode: 1, AccountId: 2}},
					session3.String(): {SessionID: session3, RoleAlignment: 1, XPID: evr.EvrId{PlatformCode: 1, AccountId: 3}},
				},
				reservationMap: map[string]*slotReservation{
					session4.String(): {
						Presence: &EvrMatchPresence{SessionID: session4, RoleAlignment: 1, XPID: evr.EvrId{PlatformCode: 1, AccountId: 4}},
						Expiry:   time.Now().Add(time.Minute),
					},
				},
			},
			entrant:        &EvrMatchPresence{SessionID: session5, RoleAlignment: 1, XPID: evr.EvrId{PlatformCode: 1, AccountId: 5}},
			expectedResult: false,
		...
		},
		{
			...
			state: &MatchLabel{
				...
				PlayerLimit: 8,
				presenceMap: map[string]*EvrMatchPresence{
					session1.String(): {SessionID: session1, XPID: evr.EvrId{PlatformCode: 1, AccountId: 1}},
				},
			},
			entrant:        &EvrMatchPresence{SessionID: session2, XPID: evr.EvrId{PlatformCode: 1, AccountId: 1}},
			expectedResult: false,
		...
		},
		{
			...
			entrant:        &EvrMatchPresence{SessionID: session1, RoleAlignment: evr.TeamUnassigned, XPID: evr.EvrId{PlatformCode: 1, AccountId: 1}},
			expectedResult: false,
			expectedError:  nil,
		},
		{
			...
			state: &MatchLabel{
				...
				TeamSize:    4,
				presenceMap: map[string]*EvrMatchPresence{
					session1.String(): {SessionID: session1, RoleAlignment: evr.TeamOrange, XPID: evr.EvrId{PlatformCode: 1, AccountId: 1}},
					session2.String(): {SessionID: session2, RoleAlignment: evr.TeamOrange, XPID: evr.EvrId{PlatformCode: 1, AccountId: 2}},
					session3.String(): {SessionID: session3, RoleAlignment: evr.TeamOrange, XPID: evr.EvrId{PlatformCode: 1, AccountId: 3}},
					session4.String(): {SessionID: session4, RoleAlignment: evr.TeamOrange, XPID: evr.EvrId{PlatformCode: 1, AccountId: 4}},
				},
			},
			entrant:        &EvrMatchPresence{SessionID: session5, RoleAlignment: evr.TeamOrange, XPID: evr.EvrId{PlatformCode: 1, AccountId: 5}},
			expectedResult: false,
			expectedError:  ErrJoinRejectReasonLobbyFull,
		},
	}
